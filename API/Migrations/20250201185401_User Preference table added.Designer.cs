...
namespace API.Migrations
{
    ...
    [Migration("20250201185401_User Preference table added")]
            ...
            modelBuilder.Entity("Shared.Models.Helpers.UserPreference", b =>
                {
                    ...
                    b.Property<int>("CurrencyEntityCurrencyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CurrencyEntityCurrencyId");
            ...
            modelBuilder.Entity("Shared.Models.Helpers.UserPreference", b =>
                {
                    b.HasOne("Shared.Models.Currency.CurrencyEntity", "CurrencyEntity")
                        .WithMany()
                        .HasForeignKey("CurrencyEntityCurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
